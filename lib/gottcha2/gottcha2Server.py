...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'gottcha2'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from gottcha2.gottcha2Impl import gottcha2  # noqa @IgnorePep8
impl_gottcha2 = gottcha2(config)
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'gottcha2'
        ...
        self.rpc_service.add(impl_gottcha2.run_gottcha2,
